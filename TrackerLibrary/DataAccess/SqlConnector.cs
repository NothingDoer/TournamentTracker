    ...
    public class SqlConnector : IDataConnection
    {
        ...
        public void CreatePrice(PrizeModel model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                ...
                p.Add("@PrizeProcentage", model.PrizeProcentage);
                p.Add("@id", 0, dbType: DbType.Int32, direction: ParameterDirection.Output);
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                ...
                foreach (TournamentModel tournament in output)
                {
                    ...
                    foreach (MatchupModel matchup in matchups)
                    {
                        p = new DynamicParameters();
                        p.Add("@MatchupId", matchup.Id);
                        matchup.Entries = connection.Query<MatchupEntryModel>("dbo.MatchupEntries_GetByMatchup", p, commandType: CommandType.StoredProcedure).ToList();
